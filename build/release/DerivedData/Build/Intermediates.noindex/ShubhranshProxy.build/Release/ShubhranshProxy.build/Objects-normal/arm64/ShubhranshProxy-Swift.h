...
#ifndef SHUBHRANSHPROXY_SWIFT_H
#define SHUBHRANSHPROXY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ShubhranshProxy",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15ShubhranshProxy11AppDelegate")
...
@class NSDate;
@interface Item (SWIFT_EXTENSION(ShubhranshProxy))
